...
/**
 * main - main function
 * Description: prints the first 98 Fibonacci numbers separated by ,
...
int main(void)
{
	...
	for (counter = 2; counter < 93; counter++) /* this wil print sum */
	{
		sum = a + b;
		a = b;
		b = sum;
	...
	a_head = a / 1000000000; /* this will split larger num into 2 parts */
	a_tail = a % 1000000000;
	b_head = b / 1000000000;
	b_tail = b % 1000000000;
